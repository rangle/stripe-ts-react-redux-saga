...
const TermsOfService: React.FC = () => <div className="termsOfService">
    <ContinueShopping/>
    <h1>Terms and Conditions</h1>

    <p>Last updated: March 03, 2020</p>
    ...
    <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Shop Demo.</li>
        ...
        <li><strong>Website</strong> refers to Shop Demo, accessible from shopdevel.kene.info</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
    </ul>
    ...
    <ul>
        <li>By visiting this page on our website: https://shopdevel.kene.info/terms</li>
    </ul>
    <ContinueShopping/>
</div>
